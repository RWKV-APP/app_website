...
const APP_LATEST_VERSION_OVERRIDE = '4.4.13';
const APP_LATEST_BUILD_OVERRIDE = 727;
const IOS_LATEST_VERSION_OVERRIDE = '4.4.12';
const IOS_LATEST_BUILD_OVERRIDE = 726;
