...
const APP_LATEST_VERSION_OVERRIDE = '4.4.12';
const APP_LATEST_BUILD_OVERRIDE = 726;
const IOS_LATEST_VERSION_OVERRIDE = '4.4.11';
const IOS_LATEST_BUILD_OVERRIDE = 725;
