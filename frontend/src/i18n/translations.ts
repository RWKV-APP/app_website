...
const translations: Record<Locale, Translations> = {
  ...
  en: {
    ...
    appDescription: 'Portable, cross-platform RWKV model inference terminal powered by Flutter and C++ high-performance engine',
  ...
  ru: {
    ...
    appDescription: 'Портативный кроссплатформенный терминал для вывода моделей RWKV на базе Flutter и C++',
